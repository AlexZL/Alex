...
$sub_forum_index=1;
$blog_index=38;
$page_maker=new page_maker(2,1,38,2);
...
$blog_start_num=($page_num-1)*20;
    ...
    while($obj_blog=$result_blog->fetch_object()){
        ...
        $result_user = $user_sql->query("select `user_name`,`forum_privilege`,`forum_level`,`blog_nums`,`user_portrait_M`,`user_portrait_S` from tb_user_login_info WHERE `user_ID`=$UID");
            ...
            <div class="content_line">
                <div class="bloger_back">
                    ...
                    <div class="bloger_pic">
                        <img src="<?php echo "../../".$obj_user->user_portrait_M; ?>" id="blogger_portrait">
                    </div>
                ...
                <div id="replies_back_<?php echo $floor ?>" class="replies_back"><?php
                    ...
                    if (!isset($_SESSION["user_name"])) {
                        ...
                        while ($rep <= $rep_page_num) {
                            ?>
                            <div id="reply_<?php echo $floor . "_" . $rep; ?>" class="reply_content_one_line">
                                <div class="reply_content_one_line_replier">
                                <label for="reply_input_content_<?php echo $floor . "_" . $rep; ?>" id="replier_<?php echo $floor . "_" . $rep; ?>" onclick="replierMethod(<?php echo $floor . "," . $rep; ?>)" class="reply_label"></label>
                                </div>
                                <div class="reply_content_one_line_blank"></div>
                                <div id="replier_ID_<?php echo $floor . "_" . $rep; ?>" class="reply_content_one_line_ID"></div>
                                <div class="reply_content_one_line_middle_blank">回复</div>
                                <div class="reply_content_one_line_blank"></div>
                                <div class="reply_content_one_line_replied">
                                <label for="reply_input_content_<?php echo $floor . "_" . $rep; ?>" id="replied_<?php echo $floor . "_" . $rep; ?>" onclick="repliedMethod(<?php echo $floor . "," . $rep; ?>)" class="reply_label"></label>
                                </div>
