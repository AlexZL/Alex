...
<div id="container">
    ...
    <div id="blog_location">
        <div id="main_forum">论坛首页</div>
        <a href="<?php echo $server_ip_addr."Alex/forums/"; ?>" ><div class="forum_navigator_division"></div></a>
        <a href="<?php echo $server_ip_addr."Alex/forums/sub_forum_".$sub_forum_index.".main.php"; ?>" ><div id="sub_forum_name">Sub_forum_1</div></a>
