...
<div id="container">
    ...
    <div id="blog_location">
        ...
        <a href="<?php echo $server_ip_addr."Alex/forums/sun_forum_".$sub_forum_index."/sub_forum_".$sub_forum_index."_main.php"; ?>" ><div id="sub_forum_name">Sub_forum_1</div></a>
        <div class="forum_navigator_division"></div>
